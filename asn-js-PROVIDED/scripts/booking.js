...
dayElements.forEach(day => {
    day.addEventListener('click', () => {
        ...
        if (day.classList.contains('clicked')) {
            return; // Do nothing if day is already selected
        }

        // Add 'clicked' class to selected day and update daysNum
...
function calculateTotalCost() {
    const totalCost = costPerDay * daysNum;
